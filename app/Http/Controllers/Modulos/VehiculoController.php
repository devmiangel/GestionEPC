...
class VehiculoController extends Controller
{
    ...
    {
        $vehiculos = \App\Models\DetalleVehiculo::with(['vehiculo' => function($q) {
            $q->select('id', 'modelo_vehiculo', 'id_tipovehiculo');
        }])->get();
        $personas = \App\Models\Persona::all();
        $tipos = \App\Models\TipoVehiculo::all();
        return view('modulos.vehiculos.asignar', compact('vehiculos', 'personas', 'tipos'));
    }
