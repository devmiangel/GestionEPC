...
@section('title', 'Otras Herramientas - EPC')

@section('content')
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Otras Herramientas - EPC</title>
...
<body>
    <div class="content-wrapper">
        <div class="main-content-area">
            <h1 style="text-align: center; margin-top: 20px; font-size: 50px;"><strong>Otras Herramientas</strong></h1><br><br>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-striped">
                    <thead>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center">No hay otras herramientas disponibles</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
