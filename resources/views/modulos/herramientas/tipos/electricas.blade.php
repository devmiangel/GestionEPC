...
@section('title', 'Herramientas Eléctricas - EPC')

@section('content')
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Herramientas Eléctricas - EPC</title>
...
<body>
    <div class="content-wrapper">
        <div class="main-content-area">
            <h1 style="text-align: center; margin-top: 20px; font-size: 50px;"><strong>Herramientas Eléctricas</strong></h1><br><br>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse($electricas as $herramienta)
                        <tr>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center">No hay herramientas eléctricas disponibles</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
